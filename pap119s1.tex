...
%    pdfstartview={FitH},    % fits the width of the page to the window
    ...
    pdfauthor={Benjamin Landsteiner, David Paul},     % author
...
% alternative format:
% 
\author{\IEEEauthorblockN{Benjamin Landsteiner\IEEEauthorrefmark{1}, David Paul\IEEEauthorrefmark{2}}
\IEEEauthorblockA{\IEEEauthorrefmark{1}Cray Inc., Bloomington, MN  55425\\
Email: ben@cray.com}
...
%		enlargelimits=false,
	...
	% FPP Scratch Write
	\addlegendentry{FPP Scratch Write}
	\addplot[blue, dashed] table {data/1m_512files_32nodes_280656.WriteRate.csv};
	% FPP Scratch Read
	\addlegendentry{FPP Scratch Read}
	\addplot[red, dashed] table {data/1m_512files_32nodes_280656.ReadRate.csv};

	% FPP Cache Write
	\addlegendentry{FPP Cache Write}
	\addplot[blue] table {data/1m_512files_32nodes_280649.WriteRate.csv};
	% FPP Cache Read
	\addlegendentry{FPP Cache Read}
	\addplot[red] table {data/1m_512files_32nodes_280649.ReadRate.csv};
	\end{axis}
\end{tikzpicture}
...
%		enlargelimits=false,
	...
	% SSF Scratch Write
	\addlegendentry{SSF Scratch Write}
	\addplot[blue, dashed] table {data/1m_512files_32nodes_280655.WriteRate.csv};
	% SSF Scratch Read
	\addlegendentry{SSF Scratch Read}
	\addplot[red, dashed] table {data/1m_512files_32nodes_280655.ReadRate.csv};

	% SSF Cache Write
	\addlegendentry{SSF Cache Write}
	\addplot[blue] table {data/1m_512files_32nodes_280641.WriteRate.csv};
	% SSF Cache Read
	\addlegendentry{SSF Cache Read}
	\addplot[red] table {data/1m_512files_32nodes_280641.ReadRate.csv};
	\end{axis}
\end{tikzpicture}
...
%		},
%	]
%	% FPP cache Write 8threads
%	\addlegendentry{FPP Cache Write 8threads}
%	\addplot table {data/1m_512files_32nodes_280580.WriteRate.csv};
%	% FPP Cache Write 1thread
%	\addlegendentry{FPP Cache Write 1thread}
%	\addplot table {data/1m_512files_32nodes_280612.WriteRate.csv};
%	\end{axis}
%\end{tikzpicture}
%\caption{FPP writeback thread affect on IO.\label{xxx}}
%\end{figure*}
...
%		enlargelimits=false,
	...
	% 280573
	\addlegendentry{FPP Cache Write 8 threads}
	\addplot[blue] table {data/1m_512files_32nodes_280573.WriteRate.csv};
	
	
	% 280610
	\addlegendentry{FPP Cache Write 1 thread}
	\addplot[green] table {data/1m_512files_32nodes_280610.WriteRate.csv};
